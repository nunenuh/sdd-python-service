...
This directory contains specifications for external service integrations for the FastAPI Service boilerplate.

## Purpose

Integration specifications document how the service integrates with external systems:
