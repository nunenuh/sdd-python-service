...
from .modules.countries.apiv1.handler import router as countries_router
...
api_router.include_router(
    weather_router, prefix="/v1/weather", tags=["Weather"]
)
api_router.include_router(
    countries_router, prefix="/v1/countries", tags=["Countries"]
)
